...
script=/data1/groups/keatinglab/swans/savinovCollaboration/FragFold/fragfold/rosetta/relaxscript_modified_InterfaceRelax2019_constrainttostart.txt
...
$relaxBin -in:file:l $listfile -out:file:silent $silentfile_name -out:file:scorefile score.sc ex$args
